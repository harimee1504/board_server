...
from api.models import WorkItems
from api.models.base import session
from flask import session as flask_session
import uuid

from api.models.work_items.work_items import ItemType, State, Priority, StoryPoints
...
class UpdateWorkItem:
    def __init__(self, input):
        ...
        self.data = {
            ...
            "updated_by": flask_session["auth_state"]["user_id"],
    ...
    def initiative(self):
        ...
        if self.input.get("priority") and not self.is_valid(self.input.get("priority"), Priority):
    ...
    def feature(self):
        ...
        if not self.input.get("parent"):
            raise Exception("Feature must have a parent initiative")
    ...
    def epic(self):
        ...
        if not self.input.get("parent"):
            raise Exception("Epic must have a parent feature")
    ...
    def user_story(self):
        ...
        if not self.input.get("parent"):
            raise Exception("UserStory must have a parent epic")
